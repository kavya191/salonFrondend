    ...
    <div>
        ...
        <Carousel.Item>
          ...
          ></img>
                ...
                <Col>
                <h1 className='mt-5' style={{color:"#63475f"}}>About As</h1>
                <div>
                    <p><b>Located at Twin Park’s Centre, Lucinda’s Hair & Beauty salon <br></br> provides you a range of highly trendy hair cuts and styling, makeup, hair coloring, waxing services, spray tanning and facials. It was established in the year 2005 and has a team of highly skilled and experienced stylists.</b></p>
                </div>
                </Col>
            </Row>
            <Row>
                ...
                <p className='mt-5 text-center'>"Our mission at Lucinda’s Hair & Beauty is to provide a friendly,
